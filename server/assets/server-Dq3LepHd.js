...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ab5olCBw.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BABGM9sJ.js").then((n2) => n2.r),
    import("./start-Bq8nq54c.js"),
...
var ROUTER_BASEPATH = "n5stewardmovementDemo";
var SERVER_FN_BASE = "/n5stewardmovementDemo/_serverFn/";
