...
const appCss = "/n5stewardmovementDemo/assets/styles-DU-QBFeu.css";
...
const $$splitComponentImporter$6 = () => import("./learn-DbnEhCHA.js");
const Route$7 = createFileRoute("/learn")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Courses, testimonials and video resources to align your finances with biblical wisdom."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./groups-J1N8i5-Z.js");
const Route$6 = createFileRoute("/groups")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Whether you're an individual, family, faith leader or finance professional — find your place in the N5 movement."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./financial-professionals-D6vDrpHA.js");
const Route$5 = createFileRoute("/financial-professionals")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component"),
  head: () => ({
    meta: [{
      title: "Finance Professionals — N5 Stewardship Movement"
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./faith-based-leaders-DkbKPgXl.js");
const Route$4 = createFileRoute("/faith-based-leaders")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component"),
  head: () => ({
    meta: [{
      title: "Faith-Based Leaders — N5 Stewardship Movement"
    }]
  })
});
const conferenceImg = "/n5stewardmovementDemo/assets/conference-k6JN__eP.jpg";
const $$splitComponentImporter$2 = () => import("./conference-B3Zu2keL.js");
const Route$3 = createFileRoute("/conference")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Two days of teaching, worship and community around biblical financial stewardship. Singapore, August 2025."
    }, {
      property: "og:image",
      content: conferenceImg
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./church-community-fXlge5_a.js");
const Route$2 = createFileRoute("/church-community")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  head: () => ({
    meta: [{
      title: "Individuals & Families — N5 Stewardship Movement"
    }]
  })
});
const logoUrl = "/n5stewardmovementDemo/assets/n5-logo-Dxapq8mr.png";
function Logo({ light = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-3 group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: logoUrl,
...
var DotFilledIcon = /* @__PURE__ */ reactExports.forwardRef(function(_ref, forwardedRef) {
  var _ref$color = _ref.color, color2 = _ref$color === void 0 ? "currentColor" : _ref$color, props = _objectWithoutPropertiesLoose(_ref, _excluded$1I);
  return reactExports.createElement("svg", Object.assign({
    width: "15",
    height: "15",
    viewBox: "0 0 15 15",
...
const DropdownMenuSubTrigger = reactExports.forwardRef(({ className, inset, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  SubTrigger2,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRightIcon, { className: "ml-auto text-muted-foreground/80" })
    ]
  }
));
...
const DropdownMenuContent = reactExports.forwardRef(
  ({ className, sideOffset = 4, onPointerDown, onPointerDownOutside, onCloseAutoFocus, ...props }, ref) => {
    const isCloseFromMouse = reactExports.useRef(false);
    ...
    const handlePointerDownOutside = reactExports.useCallback(
      (e) => {
        isCloseFromMouse.current = true;
    ...
    const handleCloseAutoFocus = reactExports.useCallback(
      (e) => {
        if (onCloseAutoFocus) {
...
const DropdownMenuRadioItem = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  RadioItem2,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemIndicator2, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DotFilledIcon, { className: "h-2 w-2 fill-current" }) }) }),
      children
    ]
  }
));
...
function NavItemDropdown({ item, lightText }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { open, onOpenChange: setOpen, modal: false, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownMenuContent,
          {
            ...
            onMouseEnter: handleMouseEnter,
            onMouseLeave: handleMouseLeave,
            children: item.children?.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: c.to,
                hash: c.hash,
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x flex h-20 items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { light: lightText }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-8", children: links.map(
            (l) => l.children ? /* @__PURE__ */ jsxRuntimeExports.jsx(NavItemDropdown, { item: l, lightText }, l.label) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: l.to,
                className: cn(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu$1, { className: "h-6 w-6" })
            }
          )
        ] }),
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-background border-t border-border animate-in slide-in-from-top-4 duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x py-6 flex flex-col gap-5", children: [
          links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: l.to,
            ...
            l.children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1 pl-4 border-l border-border", children: l.children.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: c.to,
                hash: c.hash,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-ink text-ivory", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x py-20 grid gap-14 md:grid-cols-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-5 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ivory/70 max-w-sm leading-relaxed", children: "A movement equipping the Body of Christ across Asia to steward money God's way — with wisdom, generosity, and lasting kingdom impact." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-rule" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-ivory/60", children: "Est. Asia · 2024" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "eyebrow text-ivory/60 mb-5", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-ivory/85", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/learn", className: "hover:text-gold transition", children: "Learn" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/groups", className: "hover:text-gold transition", children: "Groups" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-gold transition", children: "About" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/conference", className: "hover:text-gold transition", children: "Conference" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "eyebrow text-ivory/60 mb-5", children: "Join the movement" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-ivory/85", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/church-community", className: "hover:text-gold transition", children: "Individuals & Families" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/faith-based-leaders", className: "hover:text-gold transition", children: "Faith-Based Leaders" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/financial-professionals", className: "hover:text-gold transition", children: "Finance Professionals" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-ivory/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-ivory/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " N5 Stewardship Movement Asia. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display italic", children: '"Whoever is faithful in little is faithful in much." — Luke 16:10' })
    ] }) })
  ] });
}
function PageShell({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, { overlay: navOverlay }),
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: `pt-36 pb-20 border-b relative overflow-hidden ${dark ? "bg-ink text-ivory border-white/10" : "bg-background border-ink/15"}`, children: [
    dark && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-64 h-64 bg-blue-500/5 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 opacity-50" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x grid gap-10 md:grid-cols-12 items-end relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-7 space-y-6 animate-rise", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `gold-rule ${dark ? "bg-gold shadow-[0_0_15px_rgba(234,179,8,0.3)]" : "bg-gold-dark"}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `eyebrow ${dark ? "text-gold" : "text-ink/60"}`, children: eyebrow })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "serif-display text-5xl md:text-7xl leading-[1.1]", children: title })
      ] }),
      intro && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-5 md:col-start-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-lg leading-relaxed ${dark ? "text-ivory/70 font-light" : "text-muted-foreground"}`, children: intro }) })
    ] })
  ] });
}
...
function AutoScroll(userOptions = {}) {
  ...
  function init(emblaApiInstance, optionsHandler) {
    ...
    const optionsBase = mergeOptions(defaultOptions$1, AutoScroll.globalOptions);
  ...
  function createAutoScrollBehaviour(engine) {
    ...
    function seek() {
      ...
      if (index2.get() !== currentIndex) {
        indexPrevious.set(index2.get());
        index2.set(currentIndex);
...
function isRecord(subject) {
  return isObject$2(subject) || Array.isArray(subject);
}
function canUseDOM() {
...
const moolahLogo = "data:image/jpeg;base64,";
const saltLogo = "data:image/png;base64,";
const thirstLogo = "data:image/png;base64,";
const Logos3 = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: cn("py-32 bg-secondary/20 border-t border-ink/5 overflow-hidden", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-x mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "serif-display text-4xl md:text-5xl text-ink font-bold tracking-tight", children: heading }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 w-20 bg-gold mx-auto rounded-full" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Carousel,
        {
          ...
          className: "w-full",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { className: "-ml-12", children: [...logos, ...logos, ...logos].map((logo, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            CarouselItem,
            {
              className: "pl-12 md:basis-1/3 lg:basis-1/4 xl:basis-1/5",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center p-12 bg-white/60 backdrop-blur-md border border-ink/5 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] hover:bg-white transition-all duration-700 h-60 md:h-64 group cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: logo.image,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 w-48 bg-gradient-to-r from-background to-transparent z-10 pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 right-0 w-48 bg-gradient-to-l from-background to-transparent z-10 pointer-events-none" })
    ] })
  ] });
};
...
function CouncilCarousel({
  ...
  const handleNext = reactExports.useCallback(() => setCurrentIndex((index2) => (index2 + 1) % councilMembers.length), []);
  const handlePrevious = reactExports.useCallback(() => setCurrentIndex(
    (index2) => (index2 - 1 + councilMembers.length) % councilMembers.length
  ), []);
  const handleManualAction = (idx) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex relative items-center justify-center min-h-[600px] gap-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[480px] h-[600px] rounded-2xl overflow-hidden bg-secondary flex-shrink-0 shadow-2xl relative z-0 -rotate-2 hover:rotate-0 transition-transform duration-700 ease-out p-1 border border-gold/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-gold/10 rounded-3xl shadow-[0_20px_80px_rgba(0,0,0,0.08)] p-14 ml-[-40px] z-10 max-w-2xl relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.4em] text-gold font-bold block mb-4", children: "Advisory Council" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "serif-display text-4xl text-ink mb-2 font-bold", children: currentMember.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gold tracking-widest uppercase", children: currentMember.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold/30 mb-8" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-ink/70 text-lg leading-relaxed mb-8 font-light italic", children: [
                  '"',
                  currentMember.description,
                  '"'
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center text-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-ink/40 flex flex-col justify-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold uppercase tracking-tighter", children: "Verified" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Kingdom Partner" })
                  ] })
                ] })
              ]
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden max-w-xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full aspect-[4/5] bg-secondary rounded-2xl overflow-hidden mb-8 shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0 },
              animate: { opacity: 1 },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              transition: { duration: 0.4 },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-[0.3em] text-gold font-bold block mb-2", children: "Council" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "serif-display text-3xl text-ink mb-2 font-bold", children: currentMember.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-gold tracking-widest uppercase mb-6", children: currentMember.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-ink/70 text-base leading-relaxed mb-8 font-light italic", children: [
                  '"',
                  currentMember.description,
                  '"'
                ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center gap-8 mt-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-6 h-6 transition-transform group-hover:-translate-x-1" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: councilMembers.map((_, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => handleManualAction(idx),
              className: cn(
                "w-2.5 h-2.5 rounded-full transition-all duration-500 cursor-pointer",
                idx === currentIndex ? "bg-gold scale-125 shadow-[0_0_10px_rgba(212,175,55,0.5)]" : "bg-ink/10 hover:bg-ink/30"
              )
            },
            idx
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "w-14 h-14 rounded-full bg-white border border-gold/10 shadow-lg flex items-center justify-center hover:bg-gold hover:text-white transition-all duration-500 cursor-pointer group active:scale-95",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-6 h-6 transition-transform group-hover:translate-x-1" })
            }
          )
        ] })
      ]
...
const heroImg = "/n5stewardmovementDemo/assets/hero-congregation-DhMzguxf.jpg";
const leadersImg = "/n5stewardmovementDemo/assets/leaders-pGetIxlN.jpg";
const bibleImg = "/n5stewardmovementDemo/assets/still-bible-4ECpTG8T.jpg";
const groupImg = "/n5stewardmovementDemo/assets/group-table-CcxOrJE1.jpg";
const faqInquiryImg = "/n5stewardmovementDemo/assets/faq-inquiry-Ddv-eXmE.png";
const contactConnectionImg = "/n5stewardmovementDemo/assets/contact-connection-BWgOY_NW.png";
const missionsSideImg = "/n5stewardmovementDemo/assets/missions-side-7o3MqEVC.png";
...
function SectionNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-20 z-30 bg-background/98 backdrop-blur-md border-b border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex gap-2 overflow-x-auto py-2 no-scrollbar", "aria-label": "About page sections", children: aboutSections.map((s) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        className: `group relative flex-shrink-0 px-8 py-6 text-xs font-bold tracking-[0.15em] uppercase transition-all duration-300 whitespace-nowrap ${isActive ? "text-ink" : "text-ink/40 hover:text-gold"}`,
        children: [
          s.label,
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `absolute bottom-4 left-8 right-8 h-[2.5px] bg-gold rounded-full transition-all duration-300 origin-left ${isActive ? "scale-x-100 opacity-100" : "scale-x-0 opacity-0 group-hover:scale-x-100 group-hover:opacity-100"}`
            }
          )
        ]
      },
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "missions", className: "scroll-mt-28", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-ink text-ivory py-32 overflow-hidden border-b border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: missionsSideImg, alt: "", className: "w-full h-full object-cover grayscale brightness-50" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-gold block mb-4 uppercase tracking-[0.3em]", children: "Part 01 / Missions & Beliefs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "serif-display text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1]", children: [
              "Missions & ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Beliefs." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-ivory/70 max-w-2xl leading-relaxed font-light", children: [
              "We exist to help the Church ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: '"rebuild the walls"' }),
              " today by restoring biblical stewardship of money, wealth & legacy."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-2 border border-gold/30 rounded-sm shadow-2xl rotate-1 group hover:rotate-0 transition-transform duration-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: missionsSideImg,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border border-gold/10 -m-4 rounded-sm -z-10 pointer-events-none" })
          ] }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-24 bg-white border-t border-ink/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-16 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 relative hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: leadersImg,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 flex flex-col space-y-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: leadersImg,
              alt: "Founder Bernard Lim",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 pb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-gold block mb-6 uppercase tracking-[0.2em] font-bold text-sm", children: "THE HEART OF N5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "serif-display text-5xl md:text-6xl lg:text-7xl text-ink leading-[1.1] font-bold", children: "Our Story" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-ink/70 leading-relaxed font-light", children: [
              "The ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-ink", children: "N5 Stewardship Movement" }),
              " was birthed on ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-ink", children: "7 July 2021" }),
              " after founder ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "font-semibold text-ink", children: "Bernard Lim" }),
              " was prompted to study ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("em", { className: "italic", children: "Nehemiah 5" }),
              " the moment when rebuilding Jerusalem's walls stalled because of crippling debt and financial injustice."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-ink/20", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serif-display text-xl md:text-2xl text-ink", children: item.title }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-8 pt-0 text-ink/80 leading-relaxed font-medium space-y-6", children: item.text.split("\n\n").map((paragraph, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: paragraph }, `p-${i}`)) }) })
                    }
                  )
                ]
              },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "leadership", className: "scroll-mt-28", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-ink text-ivory py-32 overflow-hidden border-b border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "", className: "w-full h-full object-cover grayscale brightness-50" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-gold block mb-4 uppercase tracking-[0.3em]", children: "Part 02 / Leadership" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "serif-display text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1]", children: [
              "A Grassroot ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Movement." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-ivory/70 max-w-2xl leading-relaxed font-light", children: [
              "We're a ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "underline decoration-gold/40 underline-offset-8 text-ivory font-normal", children: "grassroot movement" }),
              " powered by a small core team and a growing community of pastors and marketplace professionals united in advancing ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-normal italic", children: "biblical financial stewardship" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-32 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-x", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-24 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "serif-display text-5xl md:text-6xl text-ink font-bold", children: "Advisory Council" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-24 bg-gold mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CouncilCarousel, {})
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Logos3, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "faq", className: "scroll-mt-28", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-ink text-ivory py-24 md:py-32 overflow-hidden border-b border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: bibleImg, alt: "", className: "w-full h-full object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-gold block mb-6 uppercase tracking-[0.3em]", children: "Support" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "serif-display text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1]", children: [
              "Common ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Questions." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-ivory/70 max-w-2xl leading-relaxed font-light", children: [
              "Find answers to common questions about the ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ivory font-normal", children: "N5 Movement" }),
              " and how we work to advance biblical financial stewardship across Asia."
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-2 border border-gold/30 rounded-sm shadow-2xl -rotate-1 group hover:rotate-0 transition-transform duration-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-12 gap-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "serif-display text-4xl md:text-5xl mb-6", children: [
            "Frequently Asked ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Questions." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ink/60 leading-relaxed mb-8", children: "Get clarity on our organization, partnerships, and mission to advance Kingdom impact." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 bg-secondary border border-border rounded-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "serif-display text-xl mb-4 text-ink", children: "Still have questions?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-ink/70 mb-6", children: "If you can't find the answer you're looking for, please feel free to reach out to our team." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#contact", className: "inline-flex items-center gap-2 text-gold font-bold uppercase tracking-widest text-xs hover:text-ink transition-colors group", children: [
              "Contact Support ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-1" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: faqs.map((faq, idx) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                  ...
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6 items-center", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "serif-display text-xl md:text-2xl font-bold text-ink", children: faq.question })
                      ] }),
                      ...
                      ), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: cn("h-5 w-5 transition-transform duration-300", isOpen && "rotate-45") }) })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(
                ...
                ), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-8 ml-16 mr-10 text-lg text-ink/70 leading-relaxed font-light", children: faq.answer }) })
              ]
            },
            idx
          );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "scroll-mt-28", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-ink text-ivory py-24 md:py-32 overflow-hidden border-b border-gold/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: conferenceImg, alt: "", className: "w-full h-full object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eyebrow text-gold block mb-6 uppercase tracking-[0.3em]", children: "Connect" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "serif-display text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1]", children: [
              "Get In ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Touch." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl md:text-2xl text-ivory/70 max-w-2xl leading-relaxed font-light", children: [
              "Whether you have a question, an idea, or just want to say hello, feel free to reach out—",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ivory font-normal", children: "we're here to help." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 p-2 border border-gold/30 rounded-sm shadow-2xl rotate-1 group hover:rotate-0 transition-transform duration-700", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-24 bg-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-x", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "serif-display text-4xl md:text-5xl lg:text-6xl mb-6", children: [
              "Begin Your ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gold", children: "Stewardship Journey." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ink/60 text-lg leading-relaxed max-w-md", children: "Connect with our team and join a movement that carries influence beyond metrics." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-14 w-14 rounded-full bg-white border border-border flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-white transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-ink/40 block mb-1", children: "Email us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:team@n5stewards.asia", className: "text-xl font-medium text-ink hover:text-gold transition-colors", children: "team@n5stewards.asia" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 border-t border-ink/5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-ink/40 block mb-6", children: "Connect on Social" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[3/4] rounded-sm overflow-hidden shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "Community", className: "w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-sm overflow-hidden shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: groupImg, alt: "Meeting", className: "w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-sm overflow-hidden shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: leadersImg, alt: "Leaders", className: "w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[3/4] rounded-sm overflow-hidden shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: conferenceImg, alt: "Conference", className: "w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" }) })
          ] })
        ] })
      ] }) }) })
    ] })
...
const $$splitComponentImporter = () => import("./index-BPdNnu2n.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A movement equipping the Body of Christ across Asia to align finances with biblical wisdom for lasting Kingdom impact."
    }, {
      property: "og:title",
      content: "N5 Stewardship Movement — Asia"
    }, {
      property: "og:description",
      content: "Steward money God's way, together in community."
    }, {
      property: "og:image",
      content: heroImg
    }]
...
const FinancialProfessionalsRoute = Route$5.update({
  id: "/financial-professionals",
  path: "/financial-professionals",
  getParentRoute: () => Route$8
});
const FaithBasedLeadersRoute = Route$4.update({
  id: "/faith-based-leaders",
  path: "/faith-based-leaders",
  getParentRoute: () => Route$8
});
const ConferenceRoute = Route$3.update({
  id: "/conference",
  path: "/conference",
  getParentRoute: () => Route$8
});
const ChurchCommunityRoute = Route$2.update({
  id: "/church-community",
...
const rootRouteChildren = {
  IndexRoute,
  AboutRoute,
  ChurchCommunityRoute,
  ConferenceRoute,
  FaithBasedLeadersRoute,
  FinancialProfessionalsRoute,
  GroupsRoute,
  LearnRoute
};
